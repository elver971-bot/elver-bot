...
то дай Telegram username или скажи:
"Напишите мне в Telegram: @username"
Твой Telegram для связи: @elver971

Когда клиент готов к консультации —
направляй его в Telegram: @elver971
"""
